          ...
          return (
            <div key={stage.label} className="space-y-1">
              <div className="flex items-center justify-between text-xs">
                <div className="flex items-center gap-2">
                  <span className="font-semibold text-slate-800 dark:text-slate-200">{stage.label}</span>
                  {idx > 0 && (
                    <span className="text-[10px] font-mono px-1.5 py-0.5 rounded bg-purple-50 dark:bg-purple-950/40 text-[#5B4DB7] dark:text-purple-300 font-bold border border-purple-200/60 dark:border-purple-800/60">
