...
export const FollowUpToolbar: React.FC<FollowUpToolbarProps> = ({
  ...
  return (
    <div id="followup-toolbar" className="space-y-3">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2.5">
        ...
        <div className="relative flex-1 min-w-[200px] max-w-lg">
          ...
          <input
            ...
            className="w-full pl-9 pr-8 py-2 text-xs sm:text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#5B4DB7]/40 focus:border-[#5B4DB7] text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500"
          />
          {filters.search && (
            <button
              type="button"
        ...
        <div className="hidden lg:flex items-center gap-2 flex-wrap">
          ...
          {hasActiveFilters && (
            <button
              ...
              className="flex items-center gap-1 px-2.5 py-2 text-xs font-medium text-slate-500 dark:text-slate-400 hover:text-red-600 dark:hover:text-red-400 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
            >
              <X className="w-3.5 h-3.5" />
              <span>Clear</span>
            </button>
        ...
        <div className="flex lg:hidden items-center justify-between gap-2">
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-1.5 px-3 py-2 text-xs font-medium rounded-lg border transition-colors ${
              showMobileFilters || hasActiveFilters
                ? 'bg-purple-50 dark:bg-purple-950/50 text-[#5B4DB7] dark:text-purple-300 border-purple-300 dark:border-purple-800'
          ...
          {hasActiveFilters && (
            <button
              type="button"
              onClick={onResetFilters}
              className="px-3 py-2 text-xs font-medium text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-950/40 border border-red-200 dark:border-red-800 rounded-lg"
            >
              Reset
            </button>
          )}
      ...
      {showMobileFilters && (
        <div className="lg:hidden p-3.5 bg-slate-50 dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 space-y-3 animate-in fade-in duration-150">
