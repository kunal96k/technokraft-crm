...
export const CompleteFollowUpModal: React.FC<CompleteFollowUpModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-3 sm:p-4 animate-in fade-in duration-150">
      ...
      >
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 dark:border-slate-800 bg-emerald-50/40 dark:bg-emerald-950/20">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 text-xs">
          ...
          <div className="p-3.5 bg-slate-50 dark:bg-slate-950/60 rounded-xl border border-slate-200/80 dark:border-slate-800 space-y-1.5">
            ...
            <div className="text-slate-600 dark:text-slate-300">
              <span>Contact: <strong className="text-slate-800 dark:text-slate-100">{followUp.contactName}</strong></span>
              {followUp.contactDesignation && (
                <span className="text-slate-400 dark:text-slate-500"> ({followUp.contactDesignation})</span>
              )}
            </div>
            <div className="text-slate-700 dark:text-slate-300 font-medium pt-1 border-t border-slate-200/60 dark:border-slate-800">
              Purpose: <span className="font-normal text-slate-600 dark:text-slate-400">{followUp.purpose}</span>
            </div>
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-slate-800 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-emerald-500/40"
              required
            >
          ...
          {hasNextAction && (
            <div className="p-3 bg-purple-50/50 dark:bg-purple-950/30 rounded-xl border border-purple-200/80 dark:border-purple-800 space-y-3 animate-in fade-in duration-150">
              <div className="flex items-center gap-1.5 text-xs font-bold text-[#5B4DB7] dark:text-purple-300">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-2.5 py-1.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-slate-800 dark:text-slate-100"
                  >
