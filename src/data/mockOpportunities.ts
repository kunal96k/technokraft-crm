    ...
    activityHistory: [
      {
        date: '07 Sep 2026',
        time: '02:30 PM',
        description: 'Proposal delivered via official sales email to Rahul Sharma.',
        user: 'Rahul Patil',
      },
      {
        date: '06 Sep 2026',
...
export const MOCK_OPPORTUNITIES: OpportunityRecord[] = [
  {
    ...
    activities: [
      ...
      },
      {
        ...
        notes: 'Requirement confirmed after technical discovery call with CTO Rahul Sharma.',
      },
      {
        id: 'act-4',
        date: '02 Sep 2026',
    ...
    followUps: [
      {
        ...
        status: 'Pending',
        notes: 'Technical review meeting with CTO Rahul Sharma and VP Infrastructure.',
      },
    ],
  ...
  },
  {
    ...
    owner: {
      ...
      email: 'priya.sharma@technokraft.com',
    },
    businessAnalyst: {
      name: 'Amit Shah',
      role: 'Senior Business Analyst',
  ...
  },
  {
    ...
    requirement: {
      ...
      notes: 'Initial site visit completed by Business Analyst Amit Shah on 30th August.',
    },
    owner: {
      name: 'Rahul Patil',
      avatar: 'RP',
